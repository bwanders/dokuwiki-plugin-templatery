    ...
    public function handle($match, $state, $pos, Doku_Handler $handler){
        switch($state) {
            case DOKU_LEXER_ENTER:
                ...
                // create new capturer
                $capturer = new Templatery_Handler_Inline_Capture($handler->getCallWriter(), trim($capture[2]), $capture[1] == '!');
 ...
 */
class Templatery_Handler_Inline_Capture implements CallWriterInterface {
    var $callWriter;
    var $calls = array();
